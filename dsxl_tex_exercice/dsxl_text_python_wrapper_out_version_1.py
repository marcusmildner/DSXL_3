def fonction_param_exercice() : 
    ...
    dico_exercice = {
        ...
        'liste_variables' :  [ 
            ...
            'ypAq4a0ant:0' , 'quespA4bSol:\mbox{pour}x\approx -1.5\mbox{ et }x\approx 3.5' , 
            'ypAq5:-3' , 
            'ques5solS: [-3\,;\,-0.7] \cup  [2.7\,;\,4]' , 
            'x0:1' , 'yA:10' , 'yB:3' , 'varGpAq6:\searrow' , 
            'varDpAq6:\nearrow' , 'y0:-6' , 
            'fdev: x^2-2 x -5' , 
    ...
    liste_liste_parametres = [  [ '2nd' , 'développement' , 'fonction polynôme' , 'lecture graphique' , 'maximum' , 'tableau de variations' ] , 
         [ 
            'xA:-3' , 
            'xB:4.' , 
            r'ftikz:(\x)^(2.0)-2*(\x)-5' , 
